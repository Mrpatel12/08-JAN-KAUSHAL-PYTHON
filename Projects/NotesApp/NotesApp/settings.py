...
# Email Config
# Prints emails to the console instead of sending them (Great for development)
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

# If you want to use real emails later, comment out the line above and uncomment below:
